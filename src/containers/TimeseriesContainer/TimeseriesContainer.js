...
class TimeseriesContainer extends React.Component {
    ...
    handleSeriesConnect = async () => {
        ...
        if (changes.length) {
            ...
            console.log(`Asset: ${this.state.assetChecked} was connected to TimeSeries: ${seriesString}`);
        } else {
            //User actions feedback info
    ...
    render() {
        ...
        return (
            <PageContainer>
                ...
                <PageButtons>
                    <ButtonGroup>
                        <Button type="primary" onClick={this.handleSeriesConnect}>Connect</Button>
                        <Button type="primary" onClick={this.handleSeriesDisconnect}>Disconnect all</Button>
                    </ButtonGroup>
                </PageButtons>
            </PageContainer>
        );
